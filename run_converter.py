...
def run_converter():
    ...
    parser.add_argument("--output", help="Relative path to directory of where the TFRecord files will go")
    ...
    if args.xml_dir == None or args.output == None or args.jpg_path == None:
        raise argparse.ArgumentTypeError("xml_dir or output path or jpg_path is left blank, must provide relative path")
